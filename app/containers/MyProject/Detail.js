...
const investorInfo = {
  name: '施桌杰',
  avatar_url: 'https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3827605874,315914740&fm=11&gp=0.jpg',
...
class InvestDetail extends Component {
        ...
        <View style={styles.tabBox}>
          ...
          <TouchableOpacity onPress={() => this.changeTab(2)}>
            <View style={[styles.tab, tab === 2 ? styles.tabActive : null]}>
              <Text style={[styles.tabText, tab === 2 ? styles.tabTextActive : null]}>融资信息</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => this.changeTab(3)}>
            <View style={[styles.tab, tab === 3 ? styles.tabActive : null]}>
              <Text style={[styles.tabText, tab === 3 ? styles.tabTextActive : null]}>商业计划书</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
  ...
  renderProInfo() {
    ...
    return (
      <View style={[styles.level, { marginTop: 0 }]}>
        <View style={styles.infoTitleBox}>
          <Text style={styles.borderTitle}>签约投资</Text>
        </View>
        {
          proInfo.map(item => {
            return <View style={{ flexDirection: 'row', marginBottom: 20 }}>
  ...
  renderProInfo2() {
    ...
    return (
      <View style={styles.level}>
        <View style={styles.infoTitleBox}>
          <View style={styles.lbefore} />
          <Text style={styles.borderTitle}>投资邀约</Text>
        </View>
            ...
            {tab === 3 && <>
              <View style={styles.plan}>
                ...
                <Image
                  resizeMode={'cover'}
                  style={styles.planBox}
                  source={require('../../images/plan/5.jpeg')}
                />
                <Image
                  resizeMode={'cover'}
                  style={styles.planBox}
                  source={require('../../images/plan/8.jpeg')}
                />
              </View>
            </>
            }
